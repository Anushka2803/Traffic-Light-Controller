...
#Compile the Verilog files: iverilog -o trafficlight_tb.vvp trafficlight.v trafficlight_tb.v

#Run the simulation: vvp trafficlight_tb.vvp

#View the waveform (optional) using GTKWave: gtkwave
